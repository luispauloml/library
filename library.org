...
#+begin_src bibtex
@article{yin2023,
  title =        {Theoretical error formation and evaluation of
  acoustic source localization for cluster-based techniques},
  volume =       132,
  ISSN =         {0041-624X},
  ...
  author =       {Shenxin Yin and Huapan Xiao and Caibin Xu and
  Mingxi Deng and Tribikram Kundu},
  year =         2023,
  month =        jul,
  pages =        106982
}
