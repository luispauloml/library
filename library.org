...
** jeon2022: Compressive laser scanning with full steady state wavefield for structural damage detection :keywords:
:PROPERTIES:
:ID: jeon2022
:CATEGORY: Journal
:END:
...
** yu2016: Guided wave phased array beamforming and imaging in composite plates :keywords:
:PROPERTIES:
:ID: yu2016
:CATEGORY: Journal
:END:
...
** gao2021: A novel T-shaped sensor cluster for acoustic source localization :keywords:
:PROPERTIES:
:ID: gao2021
:CATEGORY: Journal
:END:
...
** anton2009: Reference-Free Damage Detection Using Instantaneous Baseline Measurements :keywords:
:PROPERTIES:
:ID: anton2009
:CATEGORY: Journal
:END:
...
** segers2021: Nonlinear local wave-direction estimation for in-sight and out-of-sight damage localization in composite plates :keywords:
:PROPERTIES:
:ID: segers2021
:CATEGORY: Journal
:END:
