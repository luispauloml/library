...
** beardsley1995: A simple scheme for self-focusing of an array :beam_forming:active_sensing:
:PROPERTIES:
:ID: beardsley1995
:CATEGORY: Journal
:END:
...
** sundararaman2005: Biologically inspired structural diagnostics through beamforming with phased transducer arrays :basic_literature:beam_forming:
:PROPERTIES:
:ID: sundararaman2005
:CATEGORY: Journal
:END:
