...
** Review of Guided-wave Structural Health Monitoring :basic_literature:guided_waves:literature_review:
:PROPERTIES:
:ID: raghavan2007
:CATEGORY: Journal
:END:
...
** Coherenceogram for leak detection in water pipes :leak_detection:signal_processing:
:PROPERTIES:
:ID: zeng2022
:CATEGORY: Journal
:END:
...
** A simple scheme for self-focusing of an array :beam_forming:active_sensing:
:PROPERTIES:
:ID: beardsley1995
:CATEGORY: Journal
:END:
...
** Biologically inspired structural diagnostics through beamforming with phased transducer arrays :basic_literature:beam_forming:
:PROPERTIES:
:ID: sundararaman2005
:CATEGORY: Journal
:END:
...
** The calculus of variations :calculus_of_variations:basic:literature:mechanics:
:PROPERTIES:
:ID: olver2021
:CATEGORY: Booklet
:END:
